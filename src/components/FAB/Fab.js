...
function Flag({ setSelectedIcon }) {
    return (
        <div onClick={() => setSelectedIcon('flag')} className='w-12 h-12 cursor-pointer sm:w-14 sm:h-14  rounded-full  bg-white flex items-center justify-center'>
...
function Suggestion({ setSelectedIcon }) {
    return (
        <div onClick={() => setSelectedIcon('suggestion')} className='w-12 h-12 cursor-pointer sm:w-14 sm:h-14 rounded-full  bg-white flex items-center justify-center'>
...
function ContactUS({ setSelectedIcon }) {
    return (
        <div onClick={() => setSelectedIcon('contactus')} className='w-12 h-12 cursor-pointer sm:w-14 sm:h-14 rounded-full  bg-white flex items-center justify-center'>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
